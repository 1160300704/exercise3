                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/dormitoryAdmin?method=search" method="post">
                        <div class="form-group">
                            <label for="keyname">字段：</label>
                            <select name="key" class="form-control" id="keyname">
                        ...
                        <div class="form-group" style="margin-left: 20px">
                            ...
                            <input type="text" class="form-control" name="value" placeholder="字段值" maxlength="12" style="width: 130px" id="value">
                        </div>
                        <div class="form-group " style="margin-left: 20px">
...
<%--                                            <div class="col-sm-9">--%>
<%--                                                <input type="text" required class="form-control" id="userid"--%>
<%--                                                       name="username" readonly placeholder="请输入用户名">--%>
<%--                                            </div>--%>
<%--                                        </div>--%>
